 ...
 * the same way.
 */
public interface Problem3DictionaryBrother<K1,K2,V> extends Iterable<Problem3DictionaryEntry<K1, K2, V>>{
     ...
     * 
     */
    V put(K1 key1, K2 key2, V value) throws Exception;
     ...
     * @throws KeyException 
     */
    V get(K1 key1, K2 key2) throws KeyException;
