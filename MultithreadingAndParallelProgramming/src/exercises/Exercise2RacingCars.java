...
public class Exercise2RacingCars extends JApplet implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1220591949703345072L;
	...
	public static void main(String[] args) {
		...
		JApplet applet = new Exercise2RacingCars();
		frame.add(applet);
	...
	class RaceCar extends JPanel implements Runnable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 1936016691597943481L;
