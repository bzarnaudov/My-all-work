...
public class Exercise20SudokuSearchAnimation extends JApplet {
	...
	public Exercise20SudokuSearchAnimation() {
		...
		for (int i = 0; i < 3; i++)
			for (int j = 0; j < 3; j++) {
				...
				panels[i][j].setBorder(BorderFactory.createLineBorder(
						Color.BLACK, 2));
			}
		for (int i = 0; i < 9; i++) {
			for (int j = 0; j < 9; j++) {
	...
	public static void main(String[] args) {
		...
		JApplet applet = new Exercise20SudokuSearchAnimation();
		frame.add(applet);
