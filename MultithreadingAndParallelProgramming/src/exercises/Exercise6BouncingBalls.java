...
public class Exercise6BouncingBalls extends JApplet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3734077239147209162L;

	public Exercise6BouncingBalls() {
	...
	public static void main(String[] args) {
		...
		JApplet applet = new Exercise6BouncingBalls();
		frame.add(applet);
	...
	class BallControlUsingThread extends JPanel implements ActionListener,
		 ...
		 * 
		 */
		private static final long serialVersionUID = 368695613470194656L;
		...
		class Ball extends JPanel implements Runnable {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 4804464958653955603L;
