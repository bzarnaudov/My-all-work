...
public class Board extends JPanel implements ActionListener {
    ...
    private final short leveldata[] = {
        51, 26, 26, 18, 26, 26, 22, 0, 19, 26, 26, 18, 26, 26, 54,
        21, 0, 0, 21, 0, 0, 17, 26, 20, 0, 0, 21, 0, 0, 21,
        17, 26, 26, 24, 18, 26, 20, 0, 17, 26, 18, 24, 26, 26, 20,
        21, 0, 0, 0, 21, 0, 29, 0, 29, 0, 21, 0, 0, 0, 21,
        17, 26, 26, 26, 20, 0, 0, 0, 0, 0, 17, 26, 26, 26, 20,
        21, 0, 0, 0, 17, 26, 22, 0, 19, 26, 20, 0, 0, 0, 21,
        17, 26, 18, 26, 20, 0, 21, 0, 21, 0, 17, 26, 26, 26, 20,
        21, 0, 21, 0, 17, 26, 24, 18, 24, 26, 20, 0, 0, 0, 21,
        21, 0, 21, 0, 21, 0, 0, 21, 0, 0, 17, 26, 22, 0, 21,
        21, 0, 25, 26, 20, 0, 27, 24, 30, 0, 21, 0, 21, 0, 21,
        21, 0, 0, 0, 21, 0, 0, 0, 0, 0, 21, 0, 21, 0, 21,
        17, 26, 18, 26, 16, 26, 18, 26, 18, 26, 16, 26, 16, 26, 20,
    ...
    private void moveGhosts(Graphics2D g2d) {
        ...
        for (i = 0; i < nrofghosts; i++) {
            if (ghostx[i] % blocksize == 0 && ghosty[i] % blocksize == 0) {
                posGhost = ghostx[i] / blocksize + nrofblocks * (int) (ghosty[i] / blocksize);
                // the shortest path
                if (i == 0) {
                ...
                if (i == 2) {
                	if (killerPacman == false) {
		        		...
		        		if (ghostx[i] / blocksize == 14 && ghosty[i] / blocksize == 14) {
		        			counterForDiagonalX = 0;
		        			counterForDiagonalY = 14;
		        		}
		        		if (ghostx[i] / blocksize == 0 && ghosty[i] / blocksize == 14) {
		        			counterForDiagonalX = 14;
		        			counterForDiagonalY = 0;
		        		}
		        		if (ghostx[i] / blocksize == 14 && ghosty[i] / blocksize == 0) {
		        			counterForDiagonalX = 0;
		        			counterForDiagonalY = 0;
		        		}
                	} else {
    ...
    private void loadImages() {
      ...
      pacman1 = new ImageIcon(this.getClass().getResource(pacman1S)).getImage();
      pacman2up = new ImageIcon(this.getClass().getResource(pacman2upS)).getImage();
      pacman3up = new ImageIcon(this.getClass().getResource(pacman3upS)).getImage();
      pacman4up = new ImageIcon(this.getClass().getResource(pacman4upS)).getImage();
      pacman2down = new ImageIcon(this.getClass().getResource(pacman2downS)).getImage();
      pacman3down = new ImageIcon(this.getClass().getResource(pacman3downS)).getImage();
      pacman4down = new ImageIcon(this.getClass().getResource(pacman4downS)).getImage();
      pacman2left = new ImageIcon(this.getClass().getResource(pacman2leftS)).getImage();
      pacman3left = new ImageIcon(this.getClass().getResource(pacman3leftS)).getImage();
      pacman4left = new ImageIcon(this.getClass().getResource(pacman4leftS)).getImage();
      pacman2right = new ImageIcon(this.getClass().getResource(pacman2rightS)).getImage();
      pacman3right = new ImageIcon(this.getClass().getResource(pacman3rightS)).getImage();
      pacman4right = new ImageIcon(this.getClass().getResource(pacman4rightS)).getImage();
